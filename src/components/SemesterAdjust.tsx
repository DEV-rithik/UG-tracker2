    ...
    <div className="mb-6 space-y-3 max-h-64 overflow-y-auto">
      {semesters.map((sem, i) => (
        <div key={i} className="bg-stone-50 rounded-xl p-4 border border-stone-100">
          <p className="text-xs tracking-widest uppercase text-stone-600 font-medium mb-3">{sem.name}</p>
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-stone-200 bg-white text-stone-800 text-xs focus:outline-none focus:ring-1 focus:ring-stone-400"
              />
            </div>
            <div>
